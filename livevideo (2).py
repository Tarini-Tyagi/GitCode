...
# Now saving video
output=cv2.VideoWriter('class.mp4',plugin,20,(640,480))    # We'll pass 20 frames per second  (480,640)---camara resolution (width,height)
# output=cv2.VideoWriter('class1.mp4',plugin,80,(640,480)) --------fast forward
# output=cv2.VideoWriter('class2.mp4',plugin,3,(640,480))  --------slow motion
